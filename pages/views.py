...
def charts(request):
    ...
    context = {
        ...
        'male': male.count(),
        'female': female.count(),
        'avr_life': life_expectancy(Person, False, False),
        'avr_life_male': life_expectancy(Person, True, False),
        'avr_life_female': life_expectancy(Person, False, True),

        'avr_med_study': study_duration(Person, False, False),
        'avr_med_study_male': study_duration(Person, True, False),
        'avr_med_study_female': study_duration(Person, False, True),
